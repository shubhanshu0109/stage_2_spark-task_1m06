...
if __name__ == '__main__':
    ...
    weather_df = spark.read.parquet(
        f"wasbs://{container_name}@{storage_account_name}.blob.core.windows.net/m06sparkbasics/weather/year=2016/month=10/day=03/part-00098-44bd3411-fbe4-4e16-b667-7ec0fc3ad489.c000.snappy.parquet")
